/* data-highchartmaps page javascript */
Theme.pages = (function (parent, me) {
    ...
    var highchart_theme = {
        ...
        title: {
            style: {
                font: '400 20px Ubuntu, "Trebuchet MS", Helvetica, Arial, sans-serif',
                color: '#000'
            }
        },
        subtitle: {
    ...
    me.init = function() {
        parent.log('Running data-highchartmaps page javascript');
    ...
    me.chart_europetz = function() {
       // Instanciate the map
        $('#chart_europetz').highcharts('Map', {
            chart: {
                spacingBottom: 20
            },
            title : {
    ...
    me.chart_usunemployment = function() {
        $.getJSON('https://www.highcharts.com/samples/data/jsonp.php?filename=us-counties-unemployment.json&callback=?', function (data) {
            ...
            options = {
                ...
                subtitle: {
                    text: 'Hover over for details; double-click to zoom in'
                },
            ...
            // Instanciate the map
            $('#chart_usunemployment').highcharts('Map', options);
        });
    };
    
    /*
    me.chart_drainage= function() {
         var series = [{
                "type": "map",
                "name": "Areas",
                "data": [{
